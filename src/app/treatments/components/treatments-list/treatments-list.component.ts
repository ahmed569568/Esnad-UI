...
export class TreatmentsListComponent extends CoreListComponent implements OnInit {
	constructor(service: TreatmentsService, us: UtilitiesService, router: Router) {
