...
export class EvaluationTypeListComponent extends CoreListComponent implements OnInit {
	constructor(service: EvaluationTypeService, us: UtilitiesService, router: Router) {
