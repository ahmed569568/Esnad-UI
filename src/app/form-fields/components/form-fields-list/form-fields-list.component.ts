...
export class FormFieldsListComponent extends CoreListComponent implements OnInit {
	constructor(service: FormFieldsService, us: UtilitiesService, router: Router) {
