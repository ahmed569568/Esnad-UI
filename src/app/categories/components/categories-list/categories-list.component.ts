...
export class CategoriesListComponent extends CoreListComponent implements OnInit {
	constructor(service: CategoriesService, us: UtilitiesService, router: Router) {
