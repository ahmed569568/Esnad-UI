...
export class ClientPriceListComponent extends CoreListComponent implements OnInit {
	constructor(service: ClientPriceService, us: UtilitiesService, router: Router) {
