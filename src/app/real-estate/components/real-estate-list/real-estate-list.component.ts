...
export class RealEstateListComponent extends CoreListComponent implements OnInit {
	constructor(service: RealEstateService, us: UtilitiesService, router: Router) {
